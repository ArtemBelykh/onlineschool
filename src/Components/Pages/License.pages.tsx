...
const LicensePages = () => {
    return (
        <Container className="fistScreenContainer__adaptive " sx={{marginTop: "120px", height: "100%", marginBottom: "50px"}}>
            ...
            <a style={{color: "blue", textDecoration: "none", fontSize: "18px"}} target="_blank" href="/license/document_54_.pdf">Отчет о результатах самообследования 2024 года г. Буй</a><br/>
